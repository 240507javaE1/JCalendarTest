...
public class TestCalendarAndOthers extends JFrame {
	...
	public TestCalendarAndOthers() {
		...
		//開始放拼圖蓋樂高...蓋一堆Jlabel...//實際上先蓋什麼元件沒差//只是強迫症才把Jlabel整理放一起的///
		...
		//上面在蓋樂高放拼圖,相對不重要(就是把按鈕等元件放上Panel時就會跑出來的東西)//
		
		//下面是Event區塊,先蓋完你的版面,確定元件都有出現後再用Event比較安全,總之Event放下面比較不會有紅字
